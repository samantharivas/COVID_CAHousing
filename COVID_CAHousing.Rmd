...
accuracy_table <- data.frame(
  Model = c("SARIMA", "Theta", "TBATS"),
  RMSE = c(sarima_accuracy[1], theta_accuracy[1], tbats_accuracy[1]),
  MAE = c(sarima_accuracy[2], theta_accuracy[2], tbats_accuracy[2]),
  MAPE = c(sarima_accuracy[3], theta_accuracy[3], tbats_accuracy[3])
)
